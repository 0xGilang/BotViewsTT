...
$ pkg install python
$ pkg install git
$ git clone https://github.com/Ruphas-Mafahl-XD/BotViewsTT
$ cd BotViewsTT
$ python setup.py
```
# **Catatan:**
- Script ini 100% gratis, dan perlu diketahui bahwa script ini saya recode dari orang vietnam. Jika anda ingin full source code tanpa enkripsi silahkan chat WhatsApp saya <a href="https://saweria.co/AryaAdinata">Klik Disini!</a>
